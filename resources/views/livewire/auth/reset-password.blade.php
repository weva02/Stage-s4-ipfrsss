                    ...
                    <div class="card z-index-0 fadeIn3 fadeInBottom">
                        ...
                        <div class="card-body">
                            ...
                            <form wire:submit.prevent="update" class="text-start">
                                ...
                                <div
                                    class=" input-group-outline mt-3 @if(strlen($email ?? '') > 0) is-filled @endif">
                                ...
                                <div
                                    class=" input-group-outline mt-3 @if(strlen($password ?? '') > 0) is-filled @endif">
                                ...
                                <div
                                    class=" input-group-outline mt-3 @if(strlen($passwordConfirmation ?? '') > 0) is-filled @endif">
