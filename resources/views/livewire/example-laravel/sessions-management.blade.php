                ...
                if (response.etudiants.length > 0) {
                    response.etudiants.forEach(function(content) {
                        ...
                        html += `<tr>
                            ...
                            <td>${content.email}</td>
                            <td>${content.phone}</td>
                            <td>${response.formation_price}</td>
                            <td>${prixReel}</td>
                            <td>${montantPaye}</td>
                            <td>${resteAPayer}</td>
                            <td>${content.paiements.map(p => p.mode_paiement ? p.mode_paiement.nom : 'N/A').join(', ')}</td>
                            <td>${content.date_paiement || 'N/A'}</td>
                            <td>
