                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $prof->phone }}</td>
                                        <td>{{ $prof->wtsp }}</td>
                                        <td>{{ $prof->typeymntprof ? $prof->typeymntprof->type : 'N/A' }}</td>
                                        <td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="prof-add-form">
                        ...
                        <div class="mb-3">
                            <label for="nation" class="form-label required">Nationalité:</label>
                            <select class="form-control" id="new-prof-nationalite" name="nationalite" required>
                                @foreach($countries as $country)
                                    <option value="{{ $country->name }}">{{ $country->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <p><strong>Genre <span class="required"></span>:</strong><br/>
                            <label><input type="radio" name="genre" value="Homme" id="new-prof-genre-homme" required> Homme</label>
                            <br>
                            <label><input type="radio" name="genre" value="Femme" id="new-prof-genre-femme" required> Femme</label>
                        </p>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="new-prof-type" name="type">
                                @foreach($types as $type)
